        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="text-center">
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col items-start leading-none">
                    <span
                      className="text-4xl font-bold text-gold-400 tracking-widest"
                      style={{
            ...
            <p className="text-navy-200 text-lg sm:text-xl max-w-2xl mx-auto mb-8 leading-relaxed">
              Join RAY INFOTECH's 3×9 Matrix MLM with just ₹2,750. Get your
              joining fee refunded on your first success, then earn commissions
              from 9% down to 1% across 9 levels.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Earn commissions across 9 levels — from 9% down to 1% of total
              collection at each level. Your joining fee is refunded when your
              first 3 direct downlines join.
            </p>
          </div>
          ...
          <div className="mb-6 p-4 rounded-xl bg-gold-500/10 border border-gold-500/30 flex items-center gap-4 max-w-lg mx-auto">
            ...
            <div>
              ...
              <div className="text-muted-foreground text-xs mt-0.5">
                Fill your 3 direct downline slots → get your full ₹2,750 joining
                fee refunded
              </div>
            </div>
            <div className="ml-auto text-gold-400 font-bold text-lg">
              ₹2,750
            </div>
          </div>
            ...
            {commissionLevels.map((lvl) => (
              ...
              >
                <CardContent className="p-3 text-center">
                  <div
                    className={`inline-flex items-center justify-center w-8 h-8 rounded-full ${lvl.bg} mb-2`}
                  >
                  ...
                  <div className={`text-sm font-bold ${lvl.color}`}>
                    {lvl.desc}
                  </div>
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="text-xs text-gold-500/60 font-mono font-bold mb-1">
                        STEP {item.step}
                      </div>
      ...
      <section className="py-16 bg-navy-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-navy-200 mb-8 text-lg">
            Join thousands of members already growing their income with RAY
            INFOTECH's Matrix MLM.
          </p>
          {isAuthenticated ? (
            <Button
              onClick={() => navigate({ to: "/register" })}
