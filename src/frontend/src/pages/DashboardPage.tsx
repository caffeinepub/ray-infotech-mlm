...
import { useGetSenderDownlines, useListMembers } from "../hooks/useQueries";
...
export default function DashboardPage() {
  ...
  const { data: _allDownlineIds = [], isLoading: downlinesLoading } =
    useGetSenderDownlines(selectedMember?.id ?? null);
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            View your network, earnings, and downline performance
          </p>
        </div>
        ...
        {selectedMember ? (
          ...
          <div className="bg-card border border-border rounded-xl p-12 text-center">
            ...
            <p className="text-muted-foreground text-sm">
              Choose a member from the list above to view their dashboard,
              earnings, and matrix tree.
            </p>
          </div>
        )}
      </div>
