...
export default function ProfileSetupModal() {
  ...
  return (
    <Dialog open={showModal}>
      <DialogContent
        className="bg-navy-800 border-gold-500/30 text-navy-50 sm:max-w-md"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
          <div className="space-y-2">
            <Label htmlFor="profile-name" className="text-navy-200">
              Full Name *
            </Label>
            <Input
              id="profile-name"
          ...
          <div className="space-y-2">
            <Label htmlFor="profile-contact" className="text-navy-200">
              Contact Info
            </Label>
            <Input
              id="profile-contact"
