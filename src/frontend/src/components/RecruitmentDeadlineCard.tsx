...
export default function RecruitmentDeadlineCard({
  member,
}: RecruitmentDeadlineCardProps) {
  ...
  // Joined timestamp
  const joinedFormatted = new Date(
    Number(member.registrationTimestamp) / 1_000_000,
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-muted-foreground text-sm mb-3">
                ...
                direct downlines within the 3-day window. All benefits and
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-muted-foreground text-sm mb-2">
                ...
                direct downlines were recruited within the 3-day deadline.
              </p>
              <div className="bg-destructive/10 border border-destructive/20 rounded-md p-3 text-xs text-muted-foreground space-y-1 mb-3">
                <p className="flex items-center gap-1.5">
                  ...
                  />{" "}
                  Membership has been cancelled automatically.
                </p>
                <p className="flex items-center gap-1.5">
                  <AlertTriangle
                    size={12}
                ...
                <p className="flex items-center gap-1.5">
                  <AlertTriangle
                    ...
                    className="text-destructive flex-shrink-0"
                  />{" "}
                  All commission and other benefits are forfeited.
                </p>
              </div>
              <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
                <span className="flex items-center gap-1">
      ...
      <CardContent className="px-5 pb-5">
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-1 text-xs text-muted-foreground mb-4">
          <span className="flex items-center gap-1">
            ...
            Joined:{" "}
            <strong className="text-foreground ml-1">{joinedFormatted}</strong>
          </span>
          <span className="flex items-center gap-1">
            <Clock size={12} className="text-amber-400" />
            Last date &amp; time:{" "}
            <strong className="text-amber-400 ml-1">{deadlineFormatted}</strong>
          </span>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="text-xs text-muted-foreground mt-1.5">
            {3 - downlineCount} more direct downline
            {3 - downlineCount !== 1 ? "s" : ""} needed to secure membership.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                <div
                  key={label}
                  className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-2 text-center"
                >
        ...
        <p className="text-xs text-muted-foreground mt-3 border-t border-amber-500/20 pt-3">
          ...
          Failure to recruit 3 direct downlines before the deadline will result
          in automatic membership cancellation. Refund amount and all benefits
          will be forfeited.
        </p>
      </CardContent>
    </Card>
